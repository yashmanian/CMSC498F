...
def parse_args():
    ...
    parser.add_argument('-r', '--resolution', default=0.05, type=float)
    parser.add_argument('-d', '--dimension', default=50.0, type=float)
    ...
    return size, origin, args.resolution, to_laser
