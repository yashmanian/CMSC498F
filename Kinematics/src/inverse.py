...
parser.add_argument('-x1',      default=3.0, type=float)
parser.add_argument('-y1',      default=-7.0, type=float)
parser.add_argument('-theta1',  default=90.0, type=float)
parser.add_argument('-axle',    default=1.0, type=float)
parser.add_argument('-wheelr',  default=2.0, type=float)
